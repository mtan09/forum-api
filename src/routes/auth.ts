...
const PUBLIC_USER_COLS =
  'id, username, avatar_url, bio, header_url, is_private, is_demo, is_admin, created_at'
...
auth.post('/login', loginLimit, async (c) => {
  ...
  const result = await pool.query(
    `SELECT u.id, u.username, u.avatar_url, u.bio, u.header_url, u.is_private, u.is_demo,
            u.is_admin, u.created_at, u.is_banned, a.email, a.email_verified, a.password_hash,
